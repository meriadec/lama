...
class AccountController(
  ...
  GET / Root / accountIdPv |>> { (accountId: UUID) =>
  ...
  POST / Root ^ jsonOf[IO, CreationRequest] |>> { (creationRequest: CreationRequest) =>
    val ra = for {
  ...
  PUT / Root / accountIdPv ^ jsonOf[IO, UpdateRequest] |>> {
  ...
  DELETE / Root / accountIdPv |>> { (accountId: UUID) =>
    ...
    val r = for {
      ...
      _ <- keychainClient
        ...
        .handleErrorWith(_ => log.info("An error occurred while deleting the keychain, moving on"))
  ...
  GET / Root / accountIdPv / "operations" +? param[Option[Long]]("blockHeight") & param[Option[
    Int
  ...
  GET / Root / accountIdPv / "utxos" +? param[Option[Int]]("limit") & param[Option[Int]](
    "offset"
  ...
  GET / Root / accountIdPv / "balances" +? param[Option[Instant]]("start") & param[Option[Instant]](
    "end"
